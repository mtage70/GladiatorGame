...
const TRAIT_EVENTS = {
    ...
    "stoic": [
        {
            ...
            outcome: { hp: 10, news: "$NAME's stoicism boosted team resolve." }
        },
        {
            id: "stoic_meditation",
            title: "Inner Calm",
    ...
    "hot_headed": [
        {
            ...
            outcome: { hp: -15, news: "$NAME got into a fight at the local tavern." }
        },
        {
            id: "hot_headed_risk",
    ...
    "jovial": [
        {
            ...
            outcome: { hp: 20, news: "$NAME's feast raised everyone's spirits." }
        },
        {
            id: "jovial_prank",
    ...
    "melancholic": [
        {
            ...
            outcome: { hp: -5, stat: { int: 2 }, news: "$NAME reflected on the tragedy of the arena." }
        },
        {
        ...
        },
        {
            ...
            outcome: { hp: -20, news: "$NAME was overcome by a fit of melancholy." }
        }
    ],
    "sanguine": [
        {
            ...
            outcome: { hp: 30, news: "$NAME's optimism is restorative." }
        },
        {
        ...
        },
        {
            ...
            outcome: { hp: 10, news: "$NAME's positivity boosted the barracks." }
        }
    ],
    "phlegmatic": [
        {
        ...
        },
        {
            ...
            outcome: { hp: 15, news: "$NAME optimized their rest time." }
        }
    ],
    "volatile": [
        {
            ...
            outcome: { stat: { str: 2 }, hp: -10, news: "$NAME is on a high today." }
        },
        {
            id: "volatile_low",
            title: "The Deep Slump",
            description: "$NAME is in a terrible mood and won't leave their bunk.",
            outcome: { hp: -25, news: "$NAME is having a rough day emotionally." }
        },
        {
    ...
    "earnest": [
        {
            ...
            outcome: { stat: { dex: 1 }, hp: -5, news: "$NAME worked twice as hard today." }
        },
        {
    ...
    "flippant": [
        ...
        },
        {
            ...
            outcome: { hp: -10, news: "$NAME's carelessness cost them a meal." }
        },
        {
    ...
    "curious": [
        ...
        },
        {
            ...
            outcome: { hp: -15, news: "$NAME's curiosity got them into trouble." }
        },
        {
            id: "curious_info",
    ...
    "apathetic": [
        {
            ...
            outcome: { hp: 15, news: "$NAME took it very easy today." }
        },
        {
            id: "apathetic_miss",
            title: "Lapsed Guard",
    ...
    "competitive": [
        ...
        },
        {
            ...
            outcome: { stat: { str: 1, con: 1 }, hp: -10, news: "$NAME broke a training record." }
        },
        {
    ...
    "humble": [
        ...
        },
        {
            ...
            outcome: { hp: 10, news: "$NAME's quiet work kept the barracks running." }
        }
    ],
    "arrogant": [
        {
    ...
    "neurotic": [
        ...
        },
        {
            ...
            outcome: { hp: -20, news: "$NAME is frayed and anxious." }
        },
        {
    ...
    "resilient": [
        {
            ...
            outcome: { hp: 30, news: "$NAME's body heals remarkably fast." }
        },
        {
            id: "resilient_mind",
            title: "Unshakable",
    ...
    "bloodthirsty": [
        {
            ...
            outcome: { stat: { str: 2 }, hp: -10, news: "$NAME's bloodlust is reaching a fever pitch." }
        },
        {
    ...
    "cautious": [
        ...
        },
        {
            ...
            outcome: { hp: 15, news: "$NAME made safety preparations." }
        },
        {
            id: "cautious_delay",
            ...
            outcome: { hp: -5, news: "$NAME's caution delayed their training." }
        }
    ],
    "frenzied": [
        {
            ...
            outcome: { stat: { str: 3 }, hp: -20, news: "$NAME's wild energy is peaking." }
        },
        {
            id: "frenzied_scare",
            title: "Wild Eyes",
        ...
        },
        {
            ...
            outcome: { hp: -30, news: "$NAME collapsed from pure exhaustion." }
        }
    ],
    "tactical": [
        {
    ...
    "defensive": [
        ...
        },
        {
            ...
            outcome: { hp: 10, news: "$NAME's defensive tips helped the whole roster." }
        },
        {
            id: "defensive_slow",
            title: "Dull Blade",
    ...
    "aggressive": [
        ...
        },
        {
            ...
            outcome: { hp: -25, news: "$NAME over-exerted themselves in a fit of aggression." }
        }
    ],
    "opportunistic": [
        {
    ...
    "reckless": [
        {
            ...
            outcome: { hp: -20, news: "$NAME did something incredibly stupid for a dare." }
        },
        {
            id: "reckless_gambit",
            title: "All-In",
        ...
        },
        {
            ...
            outcome: { hp: -10, stat: { str: 2 }, news: "$NAME's recklessness grew their strength." }
        }
    ],
    "mercy_giver": [
        {
    ...
    "ruthless": [
        ...
        },
        {
            ...
            outcome: { gold: -100, stat: { con: 2 }, hp: -10, news: "$NAME compromised their health for power." }
        }
    ],
    "precise": [
        {
    ...
    "relentless": [
        {
            ...
            outcome: { stat: { con: 2 }, hp: -40, news: "$NAME's relentless drive is literal." }
        },
        {
    ...
    "skittish": [
        {
            ...
            outcome: { hp: -5, news: "$NAME was easily rattled today." }
        },
        {
        ...
        },
        {
            ...
            choices: [
                { text: "Support them (30 G)", outcome: { gold: -30, hp: 30, news: "You helped $NAME find their courage." } },
                { text: "Let them be", outcome: { hp: -10, news: "$NAME is feeling neglected." } }
            ]
        }
    ],
    "valiant": [
        ...
        },
        {
            ...
            outcome: { hp: 10, news: "$NAME's valor gave the team a boost." }
        }
    ],
    "efficient": [
        {
            ...
            outcome: { stat: { str: 1, dex: 1 }, hp: 20, news: "$NAME found an efficient training path." }
        },
        {
            id: "efficient_save",
            title: "Penny Pincher",
        ...
        },
        {
            ...
            outcome: { hp: 30, news: "$NAME managed their energy perfectly." }
        }
    ],
    "showy": [
        {
        ...
        },
        {
            ...
            outcome: { hp: -15, news: "$NAME's style got the better of them." }
        }
    ],
    "determined": [
        {
        ...
        },
        {
            ...
            outcome: { hp: 40, news: "$NAME's iron will sped up their recovery." }
        },
        {
            id: "determined_stand",
            title: "Unshakable",
    ...
    "feral": [
        {
            ...
            outcome: { hp: 20, gold: 30, news: "$NAME's hunting provided for the team." }
        },
        {
            id: "feral_bite",
            title: "Animalistic",
    ...
    "honorable": [
        ...
        },
        {
            ...
            outcome: { hp: -10, news: "$NAME's honor is the talk of the town." }
        }
    ],
    "mercenary": [
        {
    ...
    "loyal": [
        {
            ...
            outcome: { hp: -20, news: "$NAME's loyalty is beyond question." }
        },
        {
            id: "loyal_refusal",
            title: "Bribe Refused",
        ...
        },
        {
            ...
            outcome: { hp: 10, news: "$NAME's devotion is infectious." }
        }
    ],
    "treacherous": [
        {
            ...
            choices: [
                { text: "Lash them", outcome: { hp: -50, news: "You punished $NAME for their betrayal." } },
    ...
    "idealistic": [
        ...
        },
        {
            ...
            outcome: { hp: 10, news: "$NAME's words raised team morale." }
        },
        {
            id: "idealistic_loss",
            title: "Shattered Dreams",
            description: "$NAME witnessed a fixed match and is deeply depressed by the lack of honor.",
            outcome: { hp: -10, news: "$NAME's ideals are taking a hit." }
        }
    ],
    "greedy": [
        {
    ...
    "selfless": [
        {
            ...
            outcome: { hp: -10, news: "$NAME's sacrifice helped a teammate." }
        },
        {
        ...
        },
        {
            ...
            outcome: { hp: -30, news: "$NAME risked themselves for another." }
        }
    ],
    "vengeful": [
        {
        ...
        },
        {
            ...
            outcome: { stat: { str: 2 }, hp: -10, news: "$NAME's hatred is a powerful motivator." }
        }
    ],
    "honest": [
        {
    ...
    "deceptive": [
        ...
        },
        {
            ...
            outcome: { hp: 10, news: "$NAME's deceit gave them a day of rest." }
        },
        {
            id: "deceptive_scout",
            title: "Deep Cover",
    ...
    "pious": [
        {
            ...
            outcome: { hp: 20, news: "$NAME's faith is restorative." }
        },
        {
            id: "pious_tithe",
    ...
    "rebellious": [
        ...
        },
        {
            ...
            outcome: { hp: -10, news: "$NAME broke curfew." }
        }
    ],
    "disciplined": [
        {
        ...
        },
        {
            ...
            outcome: { hp: 5, news: "$NAME's orderliness improved the living space." }
        },
        {
            id: "disciplined_wait",
            title: "Immovable",
    ...
    "selfish": [
        {
            ...
            outcome: { hp: 20, news: "$NAME prioritized their own hunger." }
        },
        {
            id: "selfish_glory",
            title: "All Me",
    ...
    "ambitious": [
        ...
        },
        {
            ...
            outcome: { stat: { str: 1, dex: 1, con: 1 }, hp: -30, news: "$NAME's ambition is pushing them hard." }
        },
        {
            id: "ambitious_scheme",
            title: "Power Play",
    ...
    "stoical_loyalty": [
        ...
        },
        {
            ...
            outcome: { hp: -20, news: "$NAME's loyalty is self-sacrificing." }
        },
        {
    ...
    "corruptible": [
        ...
        },
        {
            ...
            outcome: { stat: { str: 2 }, hp: -20, news: "$NAME chose power over health." }
        },
        {
    ...
    "empathetic": [
        {
            ...
            outcome: { hp: 10, news: "$NAME's empathy helped a teammate recover." }
        },
        {
            id: "empathetic_distress",
            title: "Heavy Heart",
            description: "$NAME is so affected by a teammate's injury that they can't even train today.",
            outcome: { hp: -10, news: "$NAME is struggling with their emotions." }
        },
        {
            id: "empathetic_aid",
            title: "True Kindness",
    ...
    "gourmet": [
        {
            ...
            outcome: { hp: 25, news: "$NAME's cooking revitalized the team." }
        },
        {
            id: "gourmet_hunger",
            title: "Poor Rations",
            description: "$NAME refused to eat the standard gruel and is feeling weak as a result.",
            outcome: { hp: -15, news: "$NAME is pining for better food." }
        },
        {
    ...
    "insomniac": [
        {
            ...
            outcome: { stat: { dex: 1 }, hp: -10, news: "$NAME's sleeplessness led to extra practice." }
        },
        {
            id: "insomniac_exhaustion",
            title: "Sleep Deprivation",
            description: "$NAME's lack of sleep has finally caught up with them. They are a mess.",
            outcome: { hp: -30, news: "$NAME is suffering from extreme fatigue." }
        },
        {
            id: "insomniac_watch",
            title: "Eagle Eyes",
    ...
    "musician": [
        {
            ...
            outcome: { hp: 15, news: "$NAME's music was very restful." }
        },
        {
            id: "musician_street",
            title: "Busing",
        ...
        },
        {
            ...
            outcome: { hp: -10, news: "$NAME's music was a bit much today." }
        }
    ],
    "early_bird": [
        {
        ...
        },
        {
            ...
            outcome: { hp: 5, news: "$NAME organized the morning session early." }
        },
        {
            id: "early_bird_tired",
            title: "Early Crash",
            description: "$NAME started so early they are completely exhausted by mid-afternoon.",
            outcome: { hp: -10, news: "$NAME ran out of steam today." }
        }
    ],
    "night_owl": [
        {
    ...
    "neat_freak": [
        {
            ...
            outcome: { hp: 5, news: "$NAME's cleaning made for a better environment." }
        },
        {
    ...
    "slovenly": [
        ...
        },
        {
            ...
            outcome: { hp: 10, news: "$NAME took a very lazy break." }
        },
        {
            ...
            outcome: { hp: -5, news: "$NAME's lack of hygiene is a problem." }
        }
    ],
    "talkative": [
        {
    ...
    "jinxed": [
        {
            ...
            outcome: { hp: -10, news: "Bad luck is following $NAME today." }
        },
        {
            id: "jinxed_spill",
            title: "Spilled Oil",
        ...
        },
        {
            ...
            outcome: { hp: -5, news: "$NAME narrowly avoided a freak accident." }
        }
    ],
    "lucky": [
        {
    ...
    "obsessive": [
        {
            ...
            outcome: { stat: { str: 1, dex: 1 }, hp: -15, news: "$NAME is obsessed with a single move." }
        },
        {
    ...
    "fastidious": [
        {
            ...
            outcome: { hp: 5, news: "$NAME's precision is helping the barracks." }
        },
        {
    ...
    "bibliophile": [
        ...
        },
        {
            ...
            outcome: { hp: 10, news: "$NAME's books are a source of team spirit." }
        }
    ],
    "wanderer": [
        {
        ...
        },
        {
            ...
            outcome: { hp: 20, news: "$NAME's exploration paid off." }
        }
    ],
    "stout": [
        {
            ...
            outcome: { hp: 40, gold: -80, news: "$NAME's appetite is legendary." }
        },
        {
            id: "stout_strength",
            title: "Extra Weight",
    ...
    "ex_soldier": [
        ...
        },
        {
            ...
            outcome: { hp: 10, news: "$NAME's service record is a point of pride." }
        },
        {
            id: "ex_soldier_pains",
            title: "Old Wounds",
            description: "An old battle injury flared up today, making it hard for $NAME to move.",
            outcome: { hp: -20, news: "$NAME's military past left some scars." }
        }
    ],
    "noble_born": [
        {
    ...
    "orphan": [
        ...
        },
        {
            ...
            outcome: { hp: 20, news: "$NAME is tough as nails." }
        }
    ],
    "scholar": [
        {
    ...
    "blacksmith": [
        ...
        },
        {
            ...
            outcome: { hp: -15, news: "$NAME pushed themselves too hard in the shop." }
        }
    ],
    "hermit": [
        {
            ...
            outcome: { hp: 40, news: "$NAME's knowledge of the wild is a lifesaver." }
        },
        {
            id: "hermit_isolation",
    ...
    "zealot": [
        {
            ...
            outcome: { stat: { str: 2 }, hp: -10, news: "$NAME's fervor is a powerful force." }
        },
        {
            id: "zealot_preach",
            title: "The Word",
    ...
    "pacifist_at_heart": [
        ...
        },
        {
            ...
            outcome: { hp: 15, news: "$NAME find solace in non-violence." }
        }
    ],
    "outlaw": [
        {
    ...
    "tribal": [
        {
            ...
            outcome: { hp: 30, news: "$NAME's tribal wisdom is restorative." }
        },
        {
            id: "tribal_scout",
            title: "Hunter's Eyes",
    ...
    "exiled": [
        ...
        },
        {
            ...
            outcome: { hp: -10, news: "$NAME is feeling the weight of their exile." }
        },
        {
            id: "exiled_strength",
            title: "Survivor",
    ...
    "widowed": [
        {
            ...
            outcome: { hp: -5, news: "$NAME is mourning." }
        },
        {
            id: "widowed_drive",
        ...
        },
        {
            ...
            outcome: { hp: 20, news: "$NAME's empathy is a gift to the team." }
        }
    ],
    "vengeful_spirit": [
        {
            ...
            outcome: { stat: { str: 2 }, hp: -20, news: "$NAME is consumed by their quest." }
        },
        {
        ...
        },
        {
            ...
            outcome: { hp: -10, news: "$NAME is being consumed by their hate." }
        }
    ],
    "mystic": [
        {
        ...
        },
        {
            ...
            outcome: { hp: 30, news: "$NAME's powers are truly mysterious." }
        }
    ],
    "mercenary_vet": [
        {
        ...
        },
        {
            ...
            outcome: { hp: -10, news: "$NAME is showing their age." }
        }
    ],
    "redeemed": [
        {
            ...
            outcome: { hp: 30, news: "$NAME's quest for redemption is inspiring." }
        },
        {
            id: "redeemed_guilt",
